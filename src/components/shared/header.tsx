      ...
      <Container className="py-[42px] flex ">
        ...
        <div className=" flex gap-x-[16px] content-end ml-auto">
          ...
          <button className="relative group flex gap-x-[13px] bg-[#fe5f00] rounded-[15px] text-white items-center px-[23px] py-[12px] transition duration-[300ms] ease-[cubic-bezier(0.4,0,0.2,1)] hover:bg-[#fec300] focus:bg-[#fec300]">
            ...
            <div className="flex gap-x-2 items-center transition ease-[cubic-bezier(0.4,0,0.2,1)]  duration-[300ms] group-hover:opacity-0 group-focus:opacity-0 ">
              <svg width="16" height="16" className="stroke-[#fff] ">
                <use href="/pizza/assets/sprite.svg#icon-Shopping-cart" />
              </svg>
              <b>3</b>
            </div>
            <div className="absolute transition ease-[cubic-bezier(0.4,0,0.2,1)] -translate-x-[20px]  right-0 mr-[20px] duration-[300ms]  opacity-0 group-hover:opacity-100  group-hover:translate-x-0  group-focus:opacity-100 group-focus:translate-x-0  ">
